...
// Last Modified: Alana Wilcoxson, January 24, 2017
...
//------------|| ST7735_splitScreen ||---------
//Print to the top or bottom screen on the ST7735
//Input: 
//    Device: Top screen is 1
//            Bottom screen is 2
//    Line:   Print to Lines 0-3
...
//Tests each screen to make sure it is splitting the display correctly
//Input:  None
//Output: None
...
//-----------|| ST7735_InitScreens ||-----------------
//Initializes the ST7735 for split screen use
//Input:  None
//Output: None
...
//-----------|| ST7735_ClearScreen ||-----------------
//Clears the screen back to black
//Input:
//    Device: Top screen is 1
//            Bottom screen is 2
//            Both screens is 0
