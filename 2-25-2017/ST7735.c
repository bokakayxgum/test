...
// Daniel Valvano, Alana Wilcoxson
// March 30, 2015
...
//------------|| ST7735_InitScreens ||-----------
//Intializes the split screens
void ST7735_InitScreens(void){
  ...
  //debug
//  ST7735_OutString("The Init completed");
...
//------------|| ST7735_SplitScreen ||---------
//Prints to either the top or bottom screen
//Input:
//        device: = 1 top screen, = 2 bottom screen
//        line:   print on this line
//        string: pointer to string to print
//        value:  value to print
void ST7735_Message(int device, int line, char *string, int num){
  
  OS_bWait(&LCDFree);
  
    if(device == 2){
      ST7735_SetCursor(0,ST7735_SPLIT+line);
    } else {
...
//------------|| ST7735_ClearScreen ||---------
//Clears top screen, bottom screen or both
//Input:
//        device: = 1 top screen, = 2 bottom screen, = 3 both
void ST7735_ClearScreen(int device){
  
  if(device == 2){
     ST7735_FillRect(0,ST7735_SPLIT+36, ST7735_WIDTH, 40, ST7735_BLACK);
   } else if(device == 1){
     ST7735_FillRect(0, 0, ST7735_WIDTH, 40, ST7735_BLACK);
   } else {
    ST7735_FillScreen(ST7735_BLACK);
  }
...
//Initializes and tests the top and bottom screens
void ST7735_TestSplitScreen(void){
  
  //test split screen 1
  ST7735_SetCursor(0,0);
  ST7735_OutString("Sreen 1 starts here");
  ST7735_SetCursor(0,ST7735_SPLIT-1);
  ST7735_OutString("Sreen 1 ends here");
  
  //test split screen 2
  ST7735_SetCursor(0,ST7735_SPLIT);
  ST7735_OutString("Sreen 2 starts here");
  ST7735_SetCursor(0,ST7735_SPLIT+3);
  ST7735_OutString("Sreen 2 ends here");
